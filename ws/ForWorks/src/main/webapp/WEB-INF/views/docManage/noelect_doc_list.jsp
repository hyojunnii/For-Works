           ...
           <div class="page-heading">
               ...
               <section class="section">
					<div id="wrap">
				        ...
				        <div id="check-btn">
				            <button  class="btn btn-primary btn-sm" onclick="location.href='${root}/appmanage/nowrite'">+ 서면결재문서작성</button>
				        </div>
				        <div id="center">
                            ...
                            <c:forEach items="${voList}" var="x">
                                <div>${x.adocNo}</div>
                                <div class="title"><a href="${root}/appmanage/nodetail/${x.adocNo}">${x.adocName}</a></div>
                                <div>
                                    <c:choose>
				        ...
				        <div id="page-area">
							...
							<c:if test="${pv.endPage ne pv.maxPage }">
								<a href="${root}/appmanage/noelectman/${pv.endPage + 1}" class="btn btn-primary btn-sm">다음</a>	
							</c:if>
				        </div>
